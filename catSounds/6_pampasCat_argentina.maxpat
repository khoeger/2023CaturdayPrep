...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 419.0, 370.0, 217.0, 22.0 ],
					"text" : "sel 0 16 32 48 56 57 58 59 60 61 62 63"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 67.666666666666657, 382.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.666666666666657, 351.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 67.666666666666657, 314.0, 36.0, 22.0 ],
					"text" : "% 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 701.0, 375.0, 68.0, 20.0 ],
					"text" : "Extra High"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 343.0, 33.0, 20.0 ],
					"text" : "High"
				}
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 619.0, 450.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 21.0, 448.0, 117.0 ],
					"text" : "Pamaps Cat\n\n8/18\nArgentine Tango\nArgentina\n\nRhythm: https://www.youtube.com/watch?v=hYozfZZvMWQ\nCode Structure: https://www.youtube.com/watch?v=qXURIfP-8hU"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 628.5, 525.0, 225.5, 525.0 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 628.5, 525.0, 108.5, 525.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
